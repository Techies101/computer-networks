export const lessonList = [
  ...
  {
    slug: "cisco-configuration-of-switch",
    units: [
      {
        title: "Switches",
        lessonId: 10000,
        ...
        content: [
          {
            ...
            <div class="ero__container--left">
                <p class="topic-description">
                    In a wired network, a switch is used to link devices using Ethernet cables. Each connected device can communicate with the others thanks to the switch. Since devices such as wireless routers and adapters communicate directly with one another, wireless-only networks do not use switches, switches have many advantages:
                </p>
                <ul>
                    <li style="margin-bottom: 10px;">Switches allow you to connect multiple devices together.</li>
                    <li style="margin-bottom: 10px;">Switches prevent traffic between two devices on the same network from getting in the way of your other devices.</li>
                    <li style="margin-bottom: 10px;">You may use switches to monitor who has access to different sections of the network.</li>
                    <li style="margin-bottom: 10px;">Switches allow you to keep track of how much energy is being used.</li>
                    <li style="margin-bottom: 10px;">Switches allow faster communication (within your network) than the Internet.</li>
                    <li style="margin-bottom: 10px;">With pluggable modules, high-end switches can be customized to meet your network's needs.</li>
                </ul>
            </div>
        </div>`,
          },
          {
            ...
            text: `<div class="ero__quiz--choice-container">
            <span class="topic-heading" style="display: block;">Pop-up Quiz</span>
            <span class="topic-subheading">What is a wired network that used to link devices using Ethernet cables?</span>
                <div class="ero__quiz--choice" data-attribute="choice1">Modular Switches</div>
                <div class="ero__quiz--choice" data-attribute="choice2">Switch</div>
                <div class="ero__quiz--choice" data-attribute="choice3">Switch>delete Router</div>
                <div class="ero__quiz--choice" data-attribute="choice4">Managed Switches</div>
        </div>`,
            answer: "choice2",
          },
          {
            ...
            text: `<div class="ero__el--container">
            <div class="ero__container--left">
                <span class="topic-heading">Modular switches</span>
                <p class="topic-description">
                     modular switches, which allow you to add expansion modules as needed, giving you more flexibility as your network grows. Expansion modules for firewalls, wireless networking, and network analysis are examples of application-specific expansion modules. Additional interfaces, power supplies, and cooling fans may be possible. This move gives you the most versatility, but it comes at a higher price.
                </p>
            </div>
            <div class="ero__container--right">
                <figure class="single-image">
                    <img src="./public/assets/images/module-2-modular-switches.png" alt="transmission" style="width: 320px">
                </figure>
            </div>
        </div>`,
          },
          {
            ...
            text: `<div class="ero__el--container">
            <div class="ero__container--left">
                <span class="topic-heading">Fixed-configuration switches</span>
                <p class="topic-description">
                    Fixed-configuration switches, as shown in figure 1.2, have a fixed number of ports and are not usually expandable, but they are more expensive in the long run. Unmanaged switches, smart switches, and controlled switches are all examples of fixed-configuration switches.
                </p>
            </div>
    
            <div class="ero__container--right">
                <figure class="single-image">
                    <img src="./public/assets/images/module-2fixed-configuration-switch.png" alt="transmission" style="width: 320px">
                </figure>
            </div>
        </div>`,
          },
          {
            ...
            text: `<div class="ero__quiz--choice-container">
            <span class="topic-heading" style="display: block;">Pop-up Quiz</span>
            <span class="topic-subheading">What is a fixed number of ports and are not usually expandable, but they are more expensive in the long run?
            </span>
                <div class="ero__quiz--choice" data-attribute="choice1">Modular Switches</div>
                <div class="ero__quiz--choice" data-attribute="choice2">Switch Switches</div>
                <div class="ero__quiz--choice" data-attribute="choice3">Fixed-configuration Switches</div>
                <div class="ero__quiz--choice" data-attribute="choice4">Managed Switches</div>
        </div>`,
            answer: "choice3",
          },
          {
            ...
            text: `<div class="ero__el--container">
            <div class="ero__container--left">
                <span class="topic-heading">Unmanaged switches</span>
                <p class="topic-description">
                    Fixed-configuration switches have a fixed number of ports and aren't necessarily expandable, although they're less expensive over time, shown in figure 1.3. Fixed-configuration switches include unmanaged switches, smart switches, and powered switches. 
                </p>
            </div>
            <div class="ero__container--right">
                <figure class="single-image">
                    <img src="./public/assets/images/module-2-unmanaged-switch.png" alt="transmission" style="width: 320px">
                </figure>
            </div>
        </div>`,
          },
          {
            ...
            text: `<div class="ero__el--container">
            <div class="ero__container--left">
                <span class="topic-heading">Smart Switches</span>
                <p class="topic-description">
                    Smart switches may be a cost-effective alternative to modular switches because they have some management and segmentation, quality of service, and security capabilities shown in figure 1.4. They aren't as scalable as managed switches, though. These switches are usually used as the backbone for smaller networks, or for low-complexity networks (while controlled switches are used in the core).
                </p>
            </div>
            <div class="ero__container--right">
                <figure class="single-image">
                    <img src="./public/assets/images/module-2-smart-switches.png" alt="transmission" style="width: 320px">
                </figure>
            </div>
        </div>`,
          },
          {
            ...
            text: `<div class="ero__quiz--choice-container">
            <span class="topic-heading" style="display: block;">Pop-up Quiz</span>
            <span class="topic-subheading">What switches may be a cost-effective alternative to modular switches because they have some management and segmentation, quality of service, and security capabilities?
            </span>
                <div class="ero__quiz--choice" data-attribute="choice1">Managed Switches</div>
                <div class="ero__quiz--choice" data-attribute="choice2">Modular Switches</div>
                <div class="ero__quiz--choice" data-attribute="choice3">Smart Switches</div>
                <div class="ero__quiz--choice" data-attribute="choice4">Unmanaged Switches</div>
        </div>`,
          },
          {
            orderRank: 8,
            ...
            text: `<div class="ero__el--container">
            <div class="ero__container--left">
                <span class="topic-heading">Managed switches</span>
                <p class="topic-description">
                    Controlled switches are the most comprehensive set of features among fixed-configuration switches, providing the best application experience, the highest levels of protection, the most precise network control and management, and the most scalability shown in figure 1.5. As a result, controlled switches are commonly used as aggregation/access switches in extremely large networks or as core switches in smaller networks. Managed switches are the most costly fixed-configuration switch option, and they're most popular in businesses with large or growing networks. 
                </p>
            </div>
            <div class="ero__container--right">
                <figure class="single-image">
                    <img src="./public/assets/images/module-2-managed-switches.png" alt="transmission" style="width: 320px">
                </figure>
            </div>
        </div>`,
          },
          {
            ...
            text: ` <div class="ero__quiz--choice-container">
            <span class="topic-heading" style="display: block;">Pop-up Quiz</span>
            <span class="topic-subheading">____________ allows you to power a device such as an IP phone, security camera, or wireless access point over the same cable that is used to transmit data?
            </span>
                <div class="ero__quiz--choice" data-attribute="choice1">Power over      Ethernet (PoE)</div>
                <div class="ero__quiz--choice" data-attribute="choice2">non-PoE</div>
                <div class="ero__quiz--choice" data-attribute="choice3">Standalone Switches</div>
                <div class="ero__quiz--choice" data-attribute="choice4">Cisco Switches</div>
        </div>`,
            answer: "choice1",
          },
          {
            ...
            <div class="ero__container--left">
                ...
                <figure class="single-image">
                    <img src="./public/assets/images/module-2-cisco-configuration.png" alt="transmission" style="width: 520px">
                </figure>
    
                <span class="topic-heading">Step: 1</span>
                <p class="topic-description">
                    To connect to the switch, use an external emulator like Telnet or PuTTY.
                    On the keyboard, the initial command prompt "Switch>" appears.
                    Next to it, type "enable" and press "Enter" shown in figure 1.6.
                </p>
    
                <figure class="single-image">
                    <img src="./public/assets/images/module2-cisco-configuration-switch-2.png" alt="transmission" style="width: 520px">
                </figure>
    
                <p class="topic-description">
                    Go into configure mode using configure terminal and Enter the configuration commands one shown in figure 1.7.
                </p>
                <p class="topic-description">Switch# configure terminal</p>
            </div>
        </div>`,
          },
          {
            ...
            text: ` <div class="ero__quiz--choice-container">
            <span class="topic-heading" style="display: block;">Pop-up Quiz</span>
            <span class="topic-subheading">What kind of external emulator was used to make the connection to the switch?
            </span>
                <div class="ero__quiz--choice" data-attribute="choice1">Putty</div>
                <div class="ero__quiz--choice" data-attribute="choice2">EXEC</div>
                <div class="ero__quiz--choice" data-attribute="choice3">Cisco or CLI</div>
                <div class="ero__quiz--choice" data-attribute="choice4">Telnet or PuTTY</div>
        </div>`,
            answer: "choice4",
          },
          {
            ...
            <div class="ero__el--container">
                <div class="ero__container--left">
                    ...
                    <figure class="single-image">
                        <img src="./public/assets/images/module-2-cisco-configuration-3.png" alt="transmission" style="width: 520px">
                    </figure>
        
                    <span class="topic-heading">Step: 2</span>
                    <p class="topic-description">
                        For the switch to operate in a specific network environment, assign a hostname shown in figure 1.8.
                    </p>
                    <p class="topic-description">Switch(config)# hostname Erovoutika</p>
                </div>
            </div>`,
          },
          {
            ...
            text: `<div class="ero__quiz--choice-container">
            <span class="topic-heading" style="display: block;">Pop-up Quiz</span>
            <span class="topic-subheading">What configuration in switch to operate in a specific network environmet, assign a hostname?
            </span>
                <div class="ero__quiz--choice" data-attribute="choice1">Switch#hostname switch</div>
                <div class="ero__quiz--choice" data-attribute="choice2">Switch#hostname switch</div>
                <div class="ero__quiz--choice" data-attribute="choice3">Switch(config)#hostname switch</div>
                <div class="ero__quiz--choice" data-attribute="choice4">Switch(config-if)#hostname switch</div>
        </div>`,
            answer: "choice3",
          },
          {
            ...
            <div class="ero__container--left">
                ...
                <figure class="single-image">
                    <img src="./public/assets/images/module-2-cisco-configuration-4.png" alt="transmission" style="width: 520px">
                </figure>
    
                <span class="topic-heading">Step: 3</span>
                <p class="topic-description">
                    Enable a secret password shown in digure 1.9 by configuring an administration password.
                </p>
                <p class="topic-description">Switch(config)# enable secret somestrongpass
                </p>
            </div>
        </div>`,
          },
          {
            ...
            text: `<div class="ero__quiz--choice-container">
            <span class="topic-heading" style="display: block;">Pop-up Quiz</span>
            <span class="topic-subheading">What configuration was used to enable a secret password?</span>
                <div class="ero__quiz--choice" data-attribute="choice1">Switch(config-if)#enable secret somestrongpass</div>
                <div class="ero__quiz--choice" data-attribute="choice2">Switch(config)#enable secret somestrongpass</div>
                <div class="ero__quiz--choice" data-attribute="choice3">Switch#enable secret somestrongpass</div>
                <div class="ero__quiz--choice" data-attribute="choice4">Switch>enable secret somestrongpass</div>
        </div>`,
            choice: "choice2",
          },
          {
            ...
            <div class="ero__container--left">
                <span class="topic-heading">Step: 4</span>
                <p class="topic-description">
                    Configure the default gateway shown in figure 2.1
                </p>
                <figure class="single-image">
                    <img src="./public/assets/images/module-2-cisco-configuration-5.png" alt="transmission" style="width: 520px">
                </figure>
                <p class="topic-description">Switch(config)# enable secret somestrongpass
                </p>
            </div>
          ...
          },
          {
            ...
            text: `<div class="ero__el--container">
            <div class="ero__container--left">
                <span class="topic-heading">Step: 5</span>
                <p class="topic-description">
                     Configure a static route Switch(config)# ip route dest_IP_address mask
                     Switch# show running-config
                </p>
                <span class="topic-heading">Step: 6</span>
                <p class="topic-description">Configure interface description shown in figure 2.2</p>
                <figure class="single-image">
                    <img src="./public/assets/images/module-2-cisco-configuration-6.png" alt="transmission" style="width: 520px">
                </figure>
                <p class="topic-description">Switch(config)# interface fastethernet 0/1 <br>
          ...
          },
          {
            ...
            text: `<div class="ero__quiz--choice-container">
            <span class="topic-heading" style="display: block;">Pop-up Quiz</span>
            <span class="topic-subheading">What configuration that interface description?
            </span>
                <div class="ero__quiz--choice" data-attribute="choice1">Switch(config)#description Development VLAN</div>
                <div class="ero__quiz--choice" data-attribute="choice2">Switch#description Development VLAN</div>
                <div class="ero__quiz--choice" data-attribute="choice3">Switch(config-if)#description Development VLAN</div>
                <div class="ero__quiz--choice" data-attribute="choice4">Switch>description Development VLAN</div>
        </div>`,
            answer: "choice3",
          },
          {
            ...
            text: `<div class="ero__el--container">
            <div class="ero__container--left">
                <span class="topic-heading">Step: 7</span>
                <p class="topic-description">
                     Clear MAC address table <br> switch#clear mac address-table
                </p>
                <span class="topic-heading">Step: 8</span>
                <p class="topic-description">Set Duplex mode shoen in figure 2.3.
                </p>
                <figure class="single-image">
                    <img src="./public/assets/images/module-2-cisco-configuration-7.png" alt="transmission" style="width: 520px">
                </figure>
                <p class="topic-description">Switch(config-if)# duplex full
                </p>
            </div>
        </div>`,
          },
          {
            ...
            text: `<div class="ero__el--container">
            <div class="ero__container--left">
                <span class="topic-heading">Step: 9</span>
                <p class="topic-description">
                     For management purposes, give the switch an IP address! Vlan 1 is allocated to management IP by default, shown in figure 2.4.
                </p>
                <figure class="single-image">
                    <img src="./public/assets/images/module-2-cisco-configuration-8.png.jpg" alt="transmission" style="width: 520px">
                </figure>
                <p class="topic-description">
                    access-switch1 (config) # interface vlan 1 <br>
                    access-switch1 (config-if) # ip address 10.1.1.200 255.255.255.0 <br>
                    access-switch1 (config-if) # exit <br>
                    access-switch1(config)# <br>
                </p>
            </div>
        </div>`,
          },
          {
            ...
            text: `<div class="ero__el--container">
            <div class="ero__container--left">
                    <span class="topic-heading">Step: 10</span>
                <p class="topic-description">Exit interface configuration mode shown in figure.
                </p>
                <figure class="single-image">
                    <img src="./public/assets/images/module-2-cisco-configuration-9.png.jpg" alt="transmission" style="width: 520px">
                </figure>
                <p class="topic-description">Switch(config-if)# exit</p>
            </div>
        </div>`,
          },
          {
            ...
            text: ` <div class="ero__quiz--choice-container">
            <span class="topic-heading" style="display: block;">Pop-up Quiz</span>
            <span class="topic-subheading">What is the exit interface configuration mode?
            </span>
                <div class="ero__quiz--choice" data-attribute="choice1">Switch(config-if)#exit</div>
                <div class="ero__quiz--choice" data-attribute="choice2">Switch(config-if)#exitt</div>
                <div class="ero__quiz--choice" data-attribute="choice3">Switch(config-if)#del</div>
                <div class="ero__quiz--choice" data-attribute="choice4">Switch(config-if)#close</div></div>`,
            answer: "choice1",
          },
          {
            orderRank: 22,
            ...
            text: `<div class="ero__el--container">
            <div class="ero__container--left">
                    <span class="topic-heading">Step: 11</span>
                <p class="topic-description">Exit interface configuration mode shown in figure.
                </p>
                <figure class="single-image">
                    <img src="./public/assets/images/module-2-cisco-configuration-10.png.jpg" alt="transmission" style="width: 520px">
                </figure>
                <p class="topic-description">Switch# write memory <br>
          ...
          },
          {
            ...
            text: `<div class="ero__quiz--choice-container">
            <span class="topic-heading" style="display: block;">Pop-up Quiz</span>
            <span class="topic-subheading">What command is using to copy the running configuration into the startup configuration?
            </span>
                <div class="ero__quiz--choice" data-attribute="choice1">Switch(config)#write memory</div>
                <div class="ero__quiz--choice" data-attribute="choice2">Switch(config-if)#write memory</div>
                <div class="ero__quiz--choice" data-attribute="choice3">Switch>write memory</div>
                <div class="ero__quiz--choice" data-attribute="choice4">Switch#write memory</div>
        </div>`,
            answer: "choice4",
          },
        ],
